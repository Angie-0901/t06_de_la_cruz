...
#SI EL CONSUMO TOTAL ESTA ENTRE LOS VALORES DE 155 Y 300 ENTONCES, MOSTRAR GANASTE UN 2DO PAR DE ZAPATOS
if (total_consumo>155 and total_consumo<=300):
    print("GANASTE UN 2DO PAR DE ZAPATOS")

#SI EL MONTO TOTAL DE CONSUMO ES MENOR A 155 SOLES ENTONCES MOSTRAR VUELVA PRONTO
if (total_consumo>80 and total_consumo<90):
    print("¡VUELVA PRONTO!")
#fin_if
